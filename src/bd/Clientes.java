 ...
 */
@Entity
@Table(name = "clientes", catalog = "cliente", schema = "")
@NamedQueries({
...
public class Clientes implements Serializable {
    ...
    public Clientes(Integer id, String nome, int idade, String cpf, String email, String senha, String sexo) {
        this.id = id;
        this.nome = nome;
        this.idade = idade;
        this.cpf = cpf;
