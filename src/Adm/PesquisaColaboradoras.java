 ...
 * @author Usuário
 */
public class PesquisaColaboradoras extends javax.swing.JFrame {
    

    /**
     * Creates new form PesquisaUsuarios
     */
    public PesquisaColaboradoras() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PesquisaColaboradoras.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PesquisaColaboradoras().setVisible(true);
